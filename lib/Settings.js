var Settings = function() {
    ...
    this.reportsUrl = "http://10.0.2.216:" + this.reports_serverPort;
    this.dbHost = "";
    this.dbName = "";
    this.dbPort = "";
    this.dbUsername = "";
    ...
    this.email_rotaciones_pass = "301206.";
    ...
    this.email_desarrollo = "desarrollo@duanaltda.com";
    this.email_desarrollo1 = "desarrollo1@duanaltda.com";
    this.email_desarrollo2 = "desarrollo2@duanaltda.com";
