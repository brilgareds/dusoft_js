...
define(["angular", "js/controllers", 'includes/slide/slideContent'
    ...
    controllers.controller('ValidacionDespachoDetalleController', [
        ...
        "$state",
        "$filter",
        "Usuario", "AprobacionDespacho", "EmpresaAprobacionDespacho", "ValidacionDespachosService","ImagenAprobacion","CentroUtilidadInduccion",
    function ($scope, $rootScope, Request, $modal, API, socket, $timeout, AlertService, localStorageService, $state, $filter,
            Sesion, AprobacionDespacho, EmpresaAprobacionDespacho, ValidacionDespachosService, ImagenAprobacion,CentroUtilidadInduccion) {
                ...
                if (multiplesDocumentosOtros[0].prefijo.length > 0 && multiplesDocumentosOtros[0].numero > 0 && (cantidadCajas > 0 || cantidadNeveras > 0)) {
                    ...
                    obj = {
                        ...
                        data: {                        
                            validacionDespachos:{
                                empresaId: $scope.datos_view.empresaSeleccionada.codigo,
                                //observacion: ($scope.documentoDespachoAprobado.observacion === undefined ? "": $scope.documentoDespachoAprobado.observacion) + "(" +prefijo + "-"+parseInt($scope.documentoDespachoAprobado.numero)+")",
