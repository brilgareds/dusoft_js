var Settings = function() {
    ...
    this.dev_dbName = "dusoft_23_01_2014";
    this.dev_dbPort = "5432";
    this.dev_dbUsername = "admin";
    this.dev_dbPassword = "admin";

    this.test_dbHost = "10.0.2.169";
    this.test_dbName = "dusoft_23_01_2014";
    this.test_dbPort = "5432";
    this.test_dbUsername = "admin";
    this.test_dbPassword = "admin";
    
    // ======= ecodev Test ==============
    this.e_test_dbHost = "190.85.166.22";
    this.e_test_dbName = "dusoft_23_01_2014";
    this.e_test_dbPort = "5432";
    this.e_test_dbUsername = "admin";
    this.e_test_dbPassword = "admin";
    //==================================
...
//===== Probando desde ecodev 
Settings.prototype.envExternalTesting = function() {
    return "e_test";
};
...
function updateEnv(context)
{
    ...
    else if (context.env === "e_test") {
        context.server_port = context.e_test_serverPort;
        context.dbHost = context.e_test_dbHost;
        context.dbName = context.e_test_dbName;
        context.dbPort = context.e_test_dbPort;
        context.dbUsername = context.e_test_dbUsername;
        context.dbPassword = context.e_test_dbPassword;
    }
