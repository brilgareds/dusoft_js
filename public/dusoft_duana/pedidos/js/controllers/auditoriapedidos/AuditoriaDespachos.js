        ...
        function($scope, $rootScope, Request, Empresa,
            ...
            that.renderListarDespachosAuditados = function(data) {
                ...
                for (var i in data.obj.despachos_auditados) {
                    ...
                    documento.setBodega(_documento.bodega);
                    ...
                    {displayName: "Opciones", cellClass: "txt-center dropdown-button",
                        cellTemplate: '<div class="btn-group">\
                                            ...
                                            <ul class="dropdown-menu dropdown-options">\
                                                ...
                                                <li ng-if="row.entity.bodega != \'03\'"><a ng-visible href="javascripts:void(0);" ng-click="sincronizarDocumento(row.entity)" >Sincronizar</a></li>\
                                            </ul>\
                                       </div>'
                    }
                ]
