define(["angular", "js/controllers"], function (angular, controllers) {
    ...
    function ($scope, $rootScope, Request, API, AlertService, Usuario,
        ...
        that.listarFacturasGeneradas = function () {
             ...
             console.log("$scope.root.termino_busqueda_fg ", $scope.root.termino_busqueda_fg)
            console.log("$scope.root.termino_busqueda_prefijo ", $scope.root.termino_busqueda_prefijo)
            console.log("$scope.root.termino_busqueda_pedido ", $scope.root.termino_busqueda_pedido)
            console.log("$scope.root.termino_busqueda_nombre ", $scope.root.termino_busqueda_nombre)
            ...
            console.log("Listar facturas obj ", obj);
