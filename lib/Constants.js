...
var Constants = function() {
    ...
    this.certicamara2 = (G.program.prod) ? "https://devv5.certifactura.co/":"https://devv5.certifactura.co/";
...
Constants.prototype.IDENTIFICADOR_DIAN = function(){
    return {
        ...
        CORREO_FACTURADOR:(G.program.prod) ? "facturacion@duanaltda.com":"facturacion@duanaltda.com", 
        CORREO_FACTURADOR_BQ:(G.program.prod) ? "shirley_bolivar@duarquint.com":"shirley_bolivar@duarquint.com", 
...
Constants.prototype.WS =function() {
    return {
            ...
            FACTURACION_ELECTRONICA:{
                ...
                SHA1:'Basic RjAwNDRVU1VBUklPMTo2MjZlMTRkMzAwZDY4MThiOTBmMDU3NjY1Y2U3ODM1NzEwYWM5OWYw',
                NUEVA_FACTURA:this.certicamara2+ "servicios/recepcionPrueba/rest/emitir",
