...
console.log("rotacion", G.sqlformatter.format(query.toString())) 
    query.then(function (resultado) {
        callback(false, resultado);
    }).catch(function (err) {
console.log("rotacion false", G.sqlformatter.format(query.toString())) 
...
console.log("listarRotacion", G.sqlformatter.format(query.toString())) 
    query.then(function (resultado) {
        callback(false, resultado);
    }).catch(function (err) {
        callback(err);
