module.exports = function (app, di_container) {
    ...
    //Generar Reporte Planilla Despacho desde pedido farmacia o pedido cliente
    app.post('/api/PlanillasDespachos/reportePlanillaDespachoPedido', function (req, res) {
        c_planillas_despachos.reportePlanillaDespachoPedido(req, res);
    });
