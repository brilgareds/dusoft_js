        ...
        function ($scope, $rootScope, Request, $modal, API, socket, $timeout, AlertService, localStorageService, $state, $filter,
            ...
            that.listarDocumentosTraslado = function () {
                ...
                var obj = {
                    session: $scope.session,
                    data: {
                        bodega_origen: usuario.empresa.centroUtilidad.bodega.codigo,
                        bodega_destino:usuario.empresa.centroUtilidad.bodega.codigo
                    }
                };
                ...
                I015Service.buscarBodega(obj, function (data) {
                    ...
                    if (data.status === 200) {
                        $scope.documentosTraslado = data.obj.listarBodegas;
                    } else {
                        AlertService.mostrarVentanaAlerta("Mensaje del sistema", data.msj);
                    }
                });
