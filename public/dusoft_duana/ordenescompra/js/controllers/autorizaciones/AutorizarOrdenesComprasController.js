...
//            ];
            ...
            console.log("qqqqqqqqqq ",modeloAutorizacion.ordenSeleccionada.productoSeleccionado.descripcion);
            console.log("aaaaaaaaaa ",banderaAutorizacion);
            console.log("usuario ",Usuario.getUsuarioActual().id);
            ...
            $scope.autorizarOrdenCompra = function(modeloAutorizacionOrdenCompra,banderaautorizacionOrdenCompra){
                ...
                if(modeloAutorizacionOrdenCompra.justificacion==='')
                {
                ...
                that.buscarAutorizacionesCompras(empresa,bodega,centroUtilidad,codigoProducto,numeroOrdenCompra,codigoLote,autorizador1,swAutorizado,observacion,autorizador2,swNoAutoriza);
            };
            ...
            that.buscarAutorizacionesCompras = function(empresa,bodega,centroUtilidad,codigoProducto,numeroOrdenCompra,codigoLote,autorizador1,swAutorizado,observacion,autorizador2,swNoAutoriza) 
            {
//               console.log(empresa); 
//               console.log(bodega); 
//               console.log(centroUtilidad); 
//               console.log(codigoProducto); 
//               console.log(numeroOrdenCompra); 
//               console.log(codigoLote); 
//               console.log(autorizador1); 
//               console.log(swAutorizado); 
//               console.log(observacion); 
//               console.log(autorizador2); 
//               console.log(swNoAutoriza); 
                var obj = {
