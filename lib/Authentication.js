...
exports.set = function(usuario, callback) {
    ...
    G.knex.raw(sql, {1:sesion_usuario.usuario_id, 2:sesion_usuario.socket_id || "", 3:sesion_usuario.auth_token, 4:sesion_usuario.device}).
