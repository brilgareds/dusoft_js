...
FacturacionClientes.prototype.procesosFacturacion = function (req, res) {
    ...
    G.Q.ninvoke(that.m_facturacion_clientes, 'procesosFacturacion', {filtro: '2'}).then(function (resultado) {
        ...
        logger.error("-----------------------------------");
        logger.error({
            "metodo": "FacturacionClientes.prototype.procesosFacturacion",
            "usuario_id": usuario,
            "parametros: ": "No tiene",
            "resultado: ": err
        });
...
FacturacionClientes.prototype.listarTiposTerceros = function (req, res) {
    ...
    G.Q.ninvoke(that.m_facturacion_clientes, 'listarTiposTerceros').then(function (resultado) {
        ...
        logger.error("-----------------------------------");
        logger.error({
            "metodo": "FacturacionClientes.prototype.listarTiposTerceros",
            "usuario_id": usuario,
            "parametros: ": "No tiene",
            "resultado: ": err
        });
...
FacturacionClientes.prototype.listarPrefijosFacturas = function (req, res) {
    ...
    G.Q.ninvoke(that.m_facturacion_clientes, 'listarPrefijosFacturas', parametros).then(function (resultado) {
        ...
        logger.error("-----------------------------------");
        logger.error({
            "metodo": "FacturacionClientes.prototype.listarPrefijosFacturas",
            "usuario_id": usuario,
...
FacturacionClientes.prototype.listarFacturasGeneradas = function (req, res) {
    ...
    G.Q.ninvoke(that.m_facturacion_clientes, 'listarFacturasGeneradas', parametros).then(function (resultado) {
        ...
        logger.error("-----------------------------------");
        logger.error({
            "metodo": "FacturacionClientes.prototype.listarFacturasGeneradas",
            "usuario_id": usuario,
            "parametros: ": parametros,
            "resultado: ": err
        });
...
FacturacionClientes.prototype.listarClientes = function (req, res) {
    ...
    G.Q.ninvoke(that.m_facturacion_clientes, 'listarClientes', parametros).then(function (resultado) {
        ...
        logger.error("-----------------------------------");
        logger.error({
            "metodo": "FacturacionClientes.prototype.listarClientes",
            "usuario_id": usuario,
            "parametros: ": parametros,
            "resultado: ": err
        });
...
FacturacionClientes.prototype.listarPedidosClientes = function (req, res) {
    ...
    G.Q.ninvoke(that.m_facturacion_clientes, 'listarPedidosClientes', parametros).then(function (resultado) {
        ...
        if (resultado.length > 0) {
            ...
            return res.send(G.utils.r(req.url, 'Consulta lista de pedidos clientes', 200, {
                listar_pedidos_clientes: listaPedidosClientes,
                lista_prefijos: resultado
            }));
        ...
        logger.error("-----------------------------------");
        logger.error({
            "metodo": "FacturacionClientes.prototype.listarPedidosClientes",
            "usuario_id": usuario,
            "parametros: ": parametros,
            "resultado: ": err
        });
...
function __listarDocumentosPedidos(that, index, pedidos, empresaId, documentos, callback) {
    ...
    G.Q.ninvoke(that.m_facturacion_clientes, 'consultarDocumentosPedidos', {
        empresaId: empresaId,
        pedidoClienteId: pedido.pedido_cliente_id,
        estado: 0
    }).then(function (resultado) {
...
FacturacionClientes.prototype.procesarDespachos = function (req, res) {
    ...
    G.Q.ninvoke(that.m_facturacion_clientes, 'consultarDireccionIp', {direccionIp: ip.substr(7, ip.length)}).then(function (resultado) {
        ...
        if (resultado.length > 0) {
            ...
            throw {
                msj: '[insertarFacturaEnProceso]: No se creo la cabecera para el proceso de facturacion',
                status: 404
            };
        }
        ...
        logger.error("-----------------------------------");
        logger.error({
            "metodo": "FacturacionClientes.prototype.procesarDespachos",
            "usuario_id": usuario,
            "parametros: ": parametros,
            "resultado: ": err
        });
...
FacturacionClientes.prototype.generarFacturasAgrupadasEnProceso = function () {
    ...
    var idProceso;
    var parametros = {
        empresaId: '', tipoIdTercero: '', terceroId: '', documentoId: '', estado: 1,
    ...
    G.Q.ninvoke(that.m_facturacion_clientes, 'procesosFacturacion', {filtro: '0'}).then(function (resultado) {
        ...
        G.Q.ninvoke(that.m_facturacion_clientes, "actualizarEstadoProcesoFacturacion", {
            id: idProceso.id,
            estado: '2'
        }).then(function (resultado) {
            ...
            logger.error("-----------------------------------");
            logger.error({
                "metodo": "FacturacionClientes.prototype.generarFacturasAgrupadasEnProceso",
...
//    var ip ='::ffff:10.0.2.158';
    ...
    var parametroBodegaDocId = {
        variable: "documento_factura_" + parametros.empresaId,
        tipoVariable: 1,
        modulo: 'FacturasDespacho'
    };
...
FacturacionClientes.prototype.__generarFacturasAgrupadas = function (parametros, parametroBodegaDocId, ip, callback) {
    ...
    G.Q.ninvoke(that.m_dispensacion_hc, 'estadoParametrizacionReformular', parametroBodegaDocId).then(function (resultado) {
        ...
        if (resultado.length > 0) {
            ...
            throw {
                msj: 'Se ha generado un error (Duplicate-key) Al crear la factura [' + documentoFacturacion[0].id + "-" + documentoFacturacion[0].numeracion + "]",
                status: 409
            };
...
FacturacionClientes.prototype.eliminarTotalTemporalFacturaConsumo = function (req, res) {
    ...
    G.Q.ninvoke(that.m_facturacion_clientes, 'eliminarProductoTemporalFacturaConsumo', parametro).then(function (resultado) {
        ...
        logger.error("-----------------------------------");
        logger.error({
            "metodo": "FacturacionClientes.prototype.eliminarTotalTemporalFacturaConsumo",
            "usuario_id": usuario,
...
function __consultarTemporaldetalleFactura(that, def, index, pedidos, callback) {
    ...
    index++;
    G.Q.ninvoke(that.m_facturacion_clientes, 'consultarDetalleTemporalFacturaConsumo', {
        pedido_cliente_id: pedido,
        estado: 3
    }).then(function (resultado) {

        if (resultado.length === 0) {
            G.Q.ninvoke(that.m_facturacion_clientes, 'actualizarEstadoFacturaPedido', {
                pedido_cliente_id: pedido,
                estado_factura_fiscal: '0'
            }, {}).then(function (resultado) {
...
FacturacionClientes.prototype.eliminarProductoTemporalFacturaConsumo = function (req, res) {
    ...
    G.Q.ninvoke(that.m_facturacion_clientes, 'eliminarProductoTemporalFacturaConsumo', parametro).then(function (resultado) {
        ...
        if (resultado.length === 0) {
            return G.Q.ninvoke(that.m_facturacion_clientes, 'actualizarEstadoFacturaPedido', {
                pedido_cliente_id: numeroPedido,
                estado_factura_fiscal: '0'
            }, {});
        } else {
            def.resolve();
        ...
        logger.error("-----------------------------------");
        logger.error({
            "metodo": "FacturacionClientes.prototype.sincronizarFactura",
            "usuario_id": usuario,
            "parametros: ": parametro,
            "resultado: ": err
        });
...
FacturacionClientes.prototype.subirArchivo = function (req, res) {
    ...
    G.Q.nfcall(__subir_archivo_plano, req.files).then(function (contenido) {
        ...
        throw {
            msj: 'Productos cargados correctamente', status: 200, data: {
                cargue_archivo: {
                    productos_validos: _productosValidosExistentes,
...
FacturacionClientes.prototype.eliminarCabeceraTemporalFacturaConsumo = function (req, res) {
    ...
    G.knex.transaction(function (transaccion) {
        ...
        logger.error("-----------------------------------");
        logger.error({
            "metodo": "FacturacionClientes.prototype.eliminarCabeceraTemporalFacturaConsumo",
            "usuario_id": usuario,
            "parametros: ": parametros,
            "resultado: ": err
        });
...
FacturacionClientes.prototype.consultarDetalleTemporalFacturaConsumo = function (req, res) {
    ...
    G.Q.ninvoke(that.m_facturacion_clientes, 'consultarDetalleTemporalFacturaConsumo', parametros).then(function (resultado) {
        ...
        logger.error("-----------------------------------");
        logger.error({
            "metodo": "FacturacionClientes.prototype.consultarDetalleTemporalFacturaConsumo",
            "usuario_id": usuario,
            "parametros: ": parametros,
            "resultado: ": err
        });
...
FacturacionClientes.prototype.generarTemporalFacturaConsumo = function (req, res) {
    ...
    var parametroBodegaDocId = {
        variable: "documento_factura_" + args.facturas_consumo.empresaId,
        tipoVariable: 1,
        modulo: 'FacturasDespacho'
    };
    var totalValorProductos = 0;
    ...
    G.Q.ninvoke(that.m_facturacion_clientes, 'consultarDetalleTemporalFacturaConsumo', parametrosDetalleTmp).then(function (resultado) {
        ...
        logger.error("-----------------------------------");
        logger.error({
            "metodo": "FacturacionClientes.prototype.generarTemporalFacturaConsumo",
            "usuario_id": usuario,
            "parametros: ": parametros,
            "parametroBodegaDocId": parametroBodegaDocId,
            "resultado: ": err
...
FacturacionClientes.prototype.listarFacturasTemporales = function (req, res) {
    ...
    G.Q.ninvoke(that.m_facturacion_clientes, 'consultarTemporalFacturaConsumo', parametros).then(function (resultado) {
        ...
        logger.error("-----------------------------------");
        logger.error({
            "metodo": "FacturacionClientes.prototype.listarFacturasTemporales",
            "usuario_id": usuario,
            "parametros: ": parametros,
            "resultado: ": err
        });
...
FacturacionClientes.prototype.buscarFarmacias = function (req, res) {
    ...
    G.Q.ninvoke(that.m_facturacion_clientes, 'buscarFarmacias', parametros).then(function (resultado) {
...
FacturacionClientes.prototype.listarFacturasConsumoBarranquillaTemporales = function (req, res) {
    ...
    G.Q.ninvoke(that.m_facturacion_clientes, 'consultarTemporalFacturaConsumoBarranquilla', parametros).then(function (resultado) {
...
FacturacionClientes.prototype.generarFacturaXConsumo = function (req, res) {
    ...
    var usuario = req.session.user.usuario_id;
    var parametroBodegaDocId = {
        variable: "documento_factura_" + args.generar_factura_consumo.empresa_id,
        tipoVariable: 1,
        modulo: 'FacturasDespacho'
    };
    ...
    G.Q.ninvoke(that.m_facturacion_clientes, 'consultarTemporalFacturaConsumo', parametros).then(function (resultado) {
        ...
        if (!resultado || resultado.length > 0) {
            ...
            var parametrosCabecera = {
                empresa_id: datosDocumentosXConsumo.cabecera[0].empresa,
...
//console.log("Aresultado ",resultado );
        ...
        G.Q.ninvoke(that.m_facturacion_clientes, 'actualizarValorTotalTemporalFacturaConsumo',
            ...
            logger.error("-----------------------------------");
            logger.error({
                "metodo": "FacturacionClientes.prototype.generarFacturaXConsumo",
                "usuario_id": usuario,
                "parametros: ": parametros,
                "resultado: ": err
            });
...
function __actualizarEstadoFacturaPedidoDespacho(that, index, datos, callback) {
    ...
    if (dato.estado_pedido === 1) {
        ...
        G.Q.ninvoke(that.m_facturacion_clientes, 'actualizarEstadoFacturaPedido', {
            ...
            return G.Q.ninvoke(that.m_facturacion_clientes, "actualizarDespacho", {
                empresa_id: dato.empresa_id,
                prefijo: dato.prefijo,
                numero: dato.numeracion
            }, {});
...
function __obtenerEstadoFacturaPedidoDespacho(that, index, datos, pedidosEstados, callback) {
    ...
    G.Q.ninvoke(that.m_facturacion_clientes, 'consultarEstadoPedido', {
        prefijo: dato.prefijo,
        numeracion: dato.factura_fiscal
    }).then(function (resultado) {
        pedidosEstados.push({
            empresa_id: dato.empresa_id,
            prefijo: dato.prefijo,
            numeracion: dato.factura_fiscal,
            pedido_cliente_id: dato.pedido_cliente_id,
            estado_pedido: resultado[0].estado_pedido
        });
...
function __obtenerDetallePorFacturar(that, index, datos, detallePorFacturar, callback) {
    ...
    G.Q.ninvoke(that.m_facturacion_clientes, 'obtenerDetallePorFacturar', {
        empresa_id: dato.empresa_id,
        estado: 0,
        prefijo_documento: dato.prefijo_documento,
        numero_documento: dato.numeracion_documento
    }).then(function (resultado) {
...
//    }).then(function (resultado) {
        ...
        logger.error("-----------------------------------");
        logger.error({
            "metodo": "FacturacionClientes.prototype.generarFacturaIndividual",
            "usuario_id": usuario,
            "parametros: ": parametros,
            "parametroBodegaDocId": parametroBodegaDocId,
            "resultado: ": err
...
FacturacionClientes.prototype.sincronizarFactura = function (req, res) {
    ...
    var parametroBodegaDocId = {
        variable: "documento_factura_" + args.sincronizar_factura.empresa_id,
        tipoVariable: 1,
        modulo: 'FacturasDespacho'
    };
...
const __productosAdjuntoOriginal = function (productos, index, productosDian, callback) {
    var item = productos[index];
    var formato = 'DD-MM-YYYY';
...
FacturacionClientes.prototype.generarSincronizacionDian = function (req, res) {
    ...
    G.Q.nfcall(__generarSincronizacionDian, that, req)
            .then(function (data) {
                resultado = data;
        ...
        Factura.set_Cvcc('CVCC#ÁÉÍÓÚÜÑ&áéíóúúñ@¿¡!');
        Factura.set_Formato('JSON');
...
function __generarSincronizacionDian(that, req, callback) {
    ...
    var parametros = {
        empresa_id: empresaId, factura_fiscal: numero, prefijo: prefijo, tipoIdTercero: '',
...
//                    parametrosReporte.cabecera.fecha_registro_pedido_array.push(G.moment(row.fecha_registro).format(format2));
        ...
        return G.Q.ninvoke(that.m_facturacion_clientes, 'procesosFacturacion', {
            filtro: '1',
...
FacturacionClientes.prototype.generarReporteFacturaGenerada = function (req, res) {
    ...
    G.Q.ninvoke(that.m_facturacion_clientes, 'listarFacturasGeneradas', parametros).then(function (resultado) {
        ...
        logger.error("-----------------------------------");
        logger.error({
            "metodo": "FacturacionClientes.prototype.generarReporteFacturaGenerada",
            "usuario_id": usuario,
            "parametros: ": parametros,
...
FacturacionClientes.prototype.generarReportePedido = function (req, res) {
    ...
    G.Q.ninvoke(that.m_usuarios, 'obtenerUsuarioPorId', usuario_id).then(function (resultado) {
        ...
        logger.error("-----------------------------------");
        logger.error({
            "metodo": "FacturacionClientes.prototype.generarReportePedido",
...
FacturacionClientes.prototype.generarReporteDespacho = function (req, res) {
    ...
    var parametrosDocumento = {
        empresa_id: args.imprimir_reporte_despacho.documento.empresa,
    ...
    G.Q.ninvoke(that.m_usuarios, 'obtenerUsuarioPorId', usuario_id).then(function (resultado) {
        ...
        logger.error("-----------------------------------");
        logger.error({
            "metodo": "FacturacionClientes.prototype.generarReporteDespacho",
            "usuario_id": usuario_id,
                         ...
                         <table border='0' width='100%' >
                           <tr>
                            <td align="center" width='30%'>
                                <p ><img src="{#asset /logocliente.png @encoding=dataURI}" style="display:block"/></p>
