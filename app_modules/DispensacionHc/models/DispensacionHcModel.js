...
DispensacionHcModel.prototype.listarUltimaDispensacionFormula = function (obj, callback) {
    ...
    var query = G.knex.column(colQuery)
            ...
            .where(G.knex.raw("to_char(entrega.fecha_entrega,'YYYY-DD-MM') =  to_char((SELECT fecha_ultima_entrega FROM dispensacion_estados WHERE evolucion_id = " + obj.evolucionId + "),'YYYY-DD-MM')"));
...
//            .where(G.knex.raw("todo.fecha_registro ilike '%'||(SELECT fecha_ultima_entrega FROM dispensacion_estados WHERE evolucion_id = " + obj.evolucionId + " )||'%' limit 1"));
            .where(G.knex.raw("to_char(todo.fecha_registro,'YYYY-DD-MM') =  to_char((SELECT fecha_ultima_entrega FROM dispensacion_estados WHERE evolucion_id = " + obj.evolucionId + " ),'YYYY-DD-MM') limit 1"));
