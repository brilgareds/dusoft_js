var Constants = function() {
    ...
    this.fi = (G.program.prod) ? "http://10.0.2.237/APP/DUSOFT_DUANA/":"http://10.0.2.237/APP/PRUEBAS_GABRIEL_ANGARITA/"; //"http://10.0.2.237/APP/PRUEBAS_ANDRES_GONZALEZ/classes/SincronizacionDusoftFI/";
    ...
    this.medipol = (G.program.prod) ? "http://dgsm.medmfen.com/ws/":"http://dgsm.medmfen.com/ws/"; 

    this.finacieroDuana = (G.program.prod) ? "http://10.0.2.229:8080/SinergiasFinanciero3-ejb/getGestionInformacionContableWS/":"http://10.0.2.229:8080/SinergiasFinanciero3-ejb/getGestionInformacionContableWS/"; 
    this.finacieroCosmitet = (G.program.prod) ? "http://10.0.2.229:8080/SinergiasFinanciero3-ejb/getGestionInformacionContableWS/":"http://10.0.2.229:8080/SinergiasFinanciero3-ejb/getGestionInformacionContableWS/"; 
