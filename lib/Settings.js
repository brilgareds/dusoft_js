var Settings = function() {
    ...
    this.dev_dbHost = "10.0.2.170";
    this.dev_dbName = "dusoft_prueba_produccion";
    this.dev_dbPort = "5432";
    this.dev_dbUsername = "admin";
    this.dev_dbPassword = "admin";
    
   /* this.dev_dbHost = "10.0.2.229";
    this.dev_dbName = "dusoft";
    this.dev_dbPort = "5432";
    this.dev_dbUsername = "dusoft";
    this.dev_dbPassword = "301206.";*/
    
    

    this.test_dbHost = "10.0.2.170";
    this.test_dbName = "dusoft_prueba_produccion";
    ...
    this.email_host = "kartal.websitewelcome.com";
    this.email_port = 465;
    this.email_user = "info@duanaltda.net";
    this.email_password = "301206.";
