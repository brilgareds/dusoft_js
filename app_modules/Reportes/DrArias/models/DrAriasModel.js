...
//   var sqlTablaNueva =" select * from reporte_dr_arias where fecha between :3 AND :4 ";
   var sqlTablaNueva =" select \
                        ...
                        where fecha between :3 AND :4 order by nom_bode,plan_descripcion,descripcion_tipo_formula,producto \
   ...
   var sqlConsulta = "\
                ...
                if(obj.filtro.consulta === 0){
                 ...
                 sql = " select * ("+sqlConsulta+ " union "+sqlTablaNueva+ " ) order by nom_bode,plan_descripcion,descripcion_tipo_formula,producto;" ;      
