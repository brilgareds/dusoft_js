define([
    ...
    controllers.controller('AAC1Controller', [
        ...
        function ($scope, $rootScope, Request, $modal, API, socket, $timeout, AlertService, localStorageService, $state, $filter,
                Usuario, Producto, Documento, AAC1Service) {

            var that = this;
            var datos_documento = localStorageService.get("documento_bodega_AAC1");
            ...
            that.listarEgresos = function () {
                ...
                AAC1Service.buscarEgresos(obj, function (data) {
            ...
            that.buscarEgresoId = function (egreso_id) {
                ...
                AAC1Service.buscarEgresoId(obj, function (data) {
                    if (data.status === 200) {
            ...
            that.listarTiposTerceros = function () {
                ...
                AAC1Service.listarTiposTerceros(obj, function (data) {
            ...
            $scope.btn_seleccionar_cliente = function () {
                $scope.opts = {
                    ...
                    templateUrl: 'views/AAC1/buscadorClientes.html',
                    scope: $scope,
                    controller: "AAC1GestionarClientesController",
                    resolve: {
            ...
            that.buscarClientePorId = function (tipo, id) {
                ...
                AAC1Service.buscarClienteId(obj, function (data) {
                    if (data.status === 200) {
            ...
            $scope.btn_seleccionar_productos = function () {
                $scope.opts = {
                    ...
                    templateUrl: 'views/AAC1/buscadorProductos.html',
                    scope: $scope,
                    controller: "AAC1GestionarProductosController",
                    resolve: {
                        Empresa: function () {
            ...
            that.listarProductosTraslado = function () {
                ...
                Request.realizarRequest(API.AAC1.CONSULTAR_PRODUCTOS_TRASLADO, "POST", obj, function (data) {
                    if (data.status === 200) {
...
//                fecha.setDate(fecha.getDate() + dias);
            ...
            that.guardarNewDocTmp = function (callback) {
                ...
                AAC1Service.crearGetDocTemporal(obj, function (data) {
                    if (data.status === 200) {
            ...
            $scope.eliminar_producto = function (parametro) {
                ...
                AAC1Service.eliminarProductoTraslado(obj, function (data) {
            ...
            that.crearDocumento = function () {
                ...
                AAC1Service.crearDocumento(obj, function (data) {
                    if (data.status === 200) {
