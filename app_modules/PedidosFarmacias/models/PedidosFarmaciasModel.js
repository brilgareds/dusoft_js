 ...
 */
PedidosFarmaciasModel.prototype.cantidad_pedidos_operario = function (responsable, callback) {
    var columnas = [
        G.knex.raw("count(*)")
    ];
    ...
    var query = G.knex("solicitud_productos_a_bodega_principal as a").
            distinct(columnas).select().
            innerJoin("solicitud_productos_a_bodega_principal_estado as b", function () {
            ...
            leftJoin("inv_bodegas_movimiento_tmp_despachos_farmacias as d", "a.solicitud_prod_a_bod_ppal_id", "d.solicitud_prod_a_bod_ppal_id").
            where(function () {
